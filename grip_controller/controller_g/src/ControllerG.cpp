...
namespace controllerg
{
    ...
    void ControllerG::onInit() {
        ...
        pub_open_R = nh.advertise<std_msgs::Float64>("/" + _uav_name_ + "/grip_right_joint_controller/command", 5);
        pub_open_L = nh.advertise<std_msgs::Float64>("/" + _uav_name_ + "/grip_left_joint_controller/command", 5);
        pub_close_R = nh.advertise<std_msgs::Float64>("/" + _uav_name_ + "/grip_right_joint_controller/command", 5);
        pub_close_L = nh.advertise<std_msgs::Float64>("/" + _uav_name_ + "/grip_left_joint_controller/command", 5);
